...
| 2 | Monolithic app.js (3138 lines, no modules) 🚧 In progress | High | Maintenance bottleneck, untestable; Task 15 step 1 done (API/auth/fetch extracted to `app/web/js/api.js`) but full split is still pending |
