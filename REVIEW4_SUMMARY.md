...
| 2 | Monolithic app.js (3138 lines, no modules) 🚧 In progress | High | Maintenance bottleneck, untestable; Task 15 steps 1-2 done (`api.js` for API/auth/fetch + `state.js` for shared state/defaults), but full split is still pending |
