...
const PARAM_HELP = {
  ...
  g_ui_style: "Визуальный стиль приложения. «Graphite Minimal» — стандартный стиль по умолчанию. «Modern Aurora» — современный glass/dashboard-стиль. Каждый стиль поддерживает тёмную и светлую тему.",
  g_theme: "Цветовая тема выбранного стиля интерфейса. Тёмная тема снижает нагрузку на глаза при работе в условиях слабого освещения.",
