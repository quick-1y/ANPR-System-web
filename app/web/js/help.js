...
const PARAM_HELP = {
  ...
  g_style: "Визуальный стиль приложения. Graphite Minimal используется по умолчанию; Aurora добавлена как отдельная заготовка для будущей палитры. Каждый стиль содержит светлую и тёмную тему.",
