...
const PARAM_HELP = {
  ...
  best_shots: "Сколько лучших OCR-наблюдений накапливается на один трек для голосования. Из них выбирается консенсус — номер, набравший кворум и наибольший суммарный вес уверенности.ВНИМАНИЕ, количество бестшотов не должно быть равным или больше макс. OCR попыток. По умолчанию 3.",
