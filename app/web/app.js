...
import {
  ...
  getCurrentChannelCustomListIds,
...
document.getElementById("plateSizeResetBtn").onclick = resetPlateSizeOverlay;
document.getElementById("roiRefreshBtn").onclick = refreshPreviewSnapshot;
document.getElementById("roiClearBtn").onclick = resetRoiPolygon;
...
(async function init() {
  ...
  configureChannels({
    ...
    openModal,
    fillChannelFilter,
    getControllers: () => controllersCache,
