...
Интерфейс использует системные шрифты браузера, увеличенную минимальную кегельную сетку и современный адаптивный дизайн: стеклянные панели, акцентную боковую навигацию, тёмную/светлую темы и увеличенные зоны клика. Дополнительные файлы шрифтов устанавливать не нужно. Для операторов со слабым зрением можно дополнительно увеличить масштаб страницы штатными средствами браузера.
