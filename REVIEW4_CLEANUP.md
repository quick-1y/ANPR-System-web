...
| 8 | Monolithic `app.js` (3138 lines) ⏳ In progress (2026-03-30 step 1) | `app/web/app.js`, `app/web/js/api.js`, `app/web/js/state.js`, `app/web/index.html` | Steps 1-2 done: API/auth extracted to `api.js`, shared state extracted to `state.js`; continue incremental module split |
