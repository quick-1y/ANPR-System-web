...
- Web UI для операторов и администраторов с системой визуальных стилей: стандартный Graphite Minimal по умолчанию и опциональный Modern Aurora; каждый стиль поддерживает тёмную и светлую тему
