...
const PARAM_HELP = {
  ...
  plate_size_editor_hint: "ЛКМ внутри рамки: перетащить. Тяните за края/углы для изменения размера.",
  roi_editor_hint: "ЛКМ по линии: добавить точку. ЛКМ по точке: перетащить. ПКМ по точке: удалить.",
